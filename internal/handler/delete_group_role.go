...
// @Router /api/v1/accounts/{accountId}/user-groups/roles/{groupRoleId} [delete]
func (h *Handler) DeleteGroupRole(c *gin.Context) {
	...
	if err = h.saga.Run(c, func(ctx context.Context, services *service.Service) error {
		...
		if err = services.GroupRole.Delete(ctx, claims.UserID, accountID, roleID); err != nil {
			zap.L().Error(err.Error())
			return err
		}
